...
ruta_csv_unico = os.path.join('Español_dataset', 'dataset_español.csv')
carpeta_base = 'nlp_español'
...
try:
    ...
    ruta_dev = os.path.join(carpeta_base, "dev_es.spacy")
    guardar_a_spacy(df_dev, ruta_dev, "Guardando dev_es.spacy")
    ...
    for i in tqdm(rango_lotes, desc="Progreso total de lotes"):
        ...
        nombre_lote = f"train_part_{num_lote}_es.spacy"
